...
export default defineNuxtConfig({
  ...
  image: {
    ...
    domains: ['cdn.fiftymillimeter.com', 'pub-77d2c63f12a143a59270d491959246da.r2.dev'],
    alias: {}
  },
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://fiftymillimeter.com/cdn-cgi/image/f=jpeg,w=1200,h=630,fit=cover/https://cdn.fiftymillimeter.com/maine/maine-00003.webp' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { property: 'og:image:type', content: 'image/jpeg' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: 'https://fiftymillimeter.com/cdn-cgi/image/f=jpeg,w=1200,h=630,fit=cover/https://cdn.fiftymillimeter.com/maine/maine-00003.webp' }
      ],
      link: [
